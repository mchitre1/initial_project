...
1. Research the files and functions that need to be changed to implement the feature
2. Avoid any product manager style sections (no success criteria, timeline, migration, etc)
